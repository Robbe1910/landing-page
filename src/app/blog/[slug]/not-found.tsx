  ...
  return (
    <main className="min-h-screen bg-white px-6 py-20">
      <div className="mx-auto max-w-2xl rounded-2xl border border-gray-200 bg-gray-50 p-8 text-center">
        <p className="text-sm uppercase tracking-[0.3em] text-[#4dd4ff]">Blog</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link
            href="/blog"
            className="inline-flex items-center rounded-full border border-gray-300 px-5 py-3 text-sm font-semibold text-gray-700 transition hover:border-[#4dd4ff] hover:text-[#3f66ff]"
          >
            Volver al blog
          </Link>
          <Link
